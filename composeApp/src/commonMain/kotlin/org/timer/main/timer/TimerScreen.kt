...
fun TimerScreen(
    ...
    ProjectsScreen(timerViewModel = viewModel, timerViewState = viewState)
}
            ...
            AnimatedVisibility(visible = isCollapsed) {
                Row(
                    ...
                    when (viewState.selectedTabIndex) {
                        0 -> KittydoroStartPauseButton(viewState, viewModel)
                        1 -> ShortBreakStartPauseButton(viewState, viewModel)
                        2 -> LongBreakStartPauseButton(viewState, viewModel)
                    }
...
@Composable
private fun ShortBreakStartPauseButton(
    viewState: TimerViewState,
    viewModel: TimerViewModel
) {
...
@Composable
private fun LongBreakStartPauseButton(
    viewState: TimerViewState,
    viewModel: TimerViewModel
) {
